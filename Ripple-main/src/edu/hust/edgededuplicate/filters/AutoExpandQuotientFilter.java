...
public class AutoExpandQuotientFilter extends QuotientFilter {
    public AutoExpandQuotientFilter(int filterId,int power_of_two, int bits_per_entry) {
        super(power_of_two, bits_per_entry);
        this.filterID = filterId;
        max_entries_before_expansion = (int)(Math.pow(2, power_of_two_size) * expansion_threshold);
        contraction_autonomously = true;
